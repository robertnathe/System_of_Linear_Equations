...
int ReadVectorMarketFile(vector<double>& B, int& num_cols); // For vectors
...
int print_tridiagonal_results (double subdiagonal[], double diagonal[], double superdiagonal[], double array_A[], double B[], vector<double>& X, int num_rows, int num_cols);
...
int Tridiagonal(const matrix<double>& A, double subdiagonal[], double diagonal[], double superdiagonal[], double array_A[], double B[], vector<double>& X, int num_rows, int num_cols)
{
  ...
  print_tridiagonal_results (&subdiagonal[0], &diagonal[0], &superdiagonal[0], &array_A[0], &B[0], X, num_rows, num_cols);
  return 0;
}
...
int Jacobi_L1_Norm(const matrix<double>& A, vector<double>& B, vector<double>& X, int num_rows, int num_cols, double tolerance, int Max_Iter) {
 std::cout << std::endl << "Implementing the Jacobi_L1_Distance method: " << std::endl;
...
int Jacobi_L2_Norm(const matrix<double>& A, vector<double>& B, vector<double>& X, int num_rows, int num_cols, double tolerance, int Max_Iter) {
  std::cout << std::endl << "Implementing the Jacobi_Residual method: " << std::endl;
...
int Gauss_Seidel_L1_Norm(const matrix<double>& A, vector<double>& B, vector<double>& X, int num_rows, int num_cols, double tolerance, int Max_Iter)
{
 std::cout << endl << "Implementing the Gauss Seidel method: " << std::endl; 
